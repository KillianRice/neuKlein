mcl_FreqCounter64.dll - ActiveX COM Object for programmers
...
mcl_LineStretcher64.dll file should be referenced to the program project.
...
Dim FCTR As New MCL_FreqCounter64.USB_FreqCounter,Status as integer
dim Freq as double
Status=FCTR.Connect
...
MCL_FreqCounter64::USB_FreqCounter ^FCTR = gcnew MCL_FreqCounter64::USB_FreqCounter();
short Status = 0;
double Freq;
System::String ^SN = "";
